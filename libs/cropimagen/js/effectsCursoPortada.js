var aspectRatio='3:2'; // ratio of the image
var x1=0; // x1 for the image selection start
var y1=0; // y1 for the image selection start
var x2=150; // x2 for the image selection start
var y2=100; // y2 for the image selection start
var selectionWidth=300; // width for the image selection start
var selectionHeight=200; // height for the image selection start
var maxWidth=900; // max width for the image selection
var maxHeight=600; // max height for the image selection
...
var bigWidthPrev=900; // 
var bigHeightPrev=600;
var thumbWidthPrev=900;
var thumbHeightPrev=600;
