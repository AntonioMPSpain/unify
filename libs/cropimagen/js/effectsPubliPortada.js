var aspectRatio='5:6'; // ratio of the image
var x1=0; // x1 for the image selection start
var y1=0; // y1 for the image selection start
var x2=100; // x2 for the image selection start
var y2=120; // y2 for the image selection start
var selectionWidth=50; // width for the image selection start
var selectionHeight=60; // height for the image selection start
var maxWidth=250; // max width for the image selection
var maxHeight=300; // max height for the image selection
var minHeight=25; // min height for the image selection
var minWidth=30; // min width for the image selection
var sizefactor=5; // factor for the real size of the uploaded image
var bigWidthPrev=250; // 
var bigHeightPrev=300;
var thumbWidthPrev=250;
var thumbHeightPrev=300;
