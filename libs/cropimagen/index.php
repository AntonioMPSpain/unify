...
if (($tipo=="portadapublicacion")||($tipo=="fichapublicacion")|| ($tipo=="portadacurso")|| ($tipo=="fichacurso")){
	...
	if($accion=='guardar'){
		...
		if ($Query){
			...
			echo pg_last_error();
			echo "<br>No se ha podido guardar, contacte con administrador.";
		}
	...
	echo "No definido en index de crop.";
}
?>