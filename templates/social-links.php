...
<ul class="social-icons <?=$pullright?>">
	...
	<li><a target="_blank" href="https://es.linkedin.com/in/activatie-ab907bba" data-original-title="Linkedin" class=" social_linkedin"></a></li>
	<li><a target="_blank" href="https://twitter.com/activatie" data-original-title="Youtube" class="rounded-x social_youtube"></a></li>
	<li><a target="_blank" href="<?=$rsspath?>rss.xml" data-original-title="RSS" class=" social_rss"></a></li>
</ul>
<!-- End Social Links -->