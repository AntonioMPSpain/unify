...
(function () {
	...
	function prepare() {
		...
		if (is_mobile) {
			...
			panel.append($('#edlist').clone());
			
			$('#nav-panel #edlist').wrap($('<div class="header-menu01">'));
		}
	};
...
(function () {
	...
	function click() {
		if (! panel_visible) {
			...
			$e.append("<div class='cursos'><a href='/web/zona-privada_usuario_1.php'>" + "Mis cursos" + "</a></div>");
			$e.append("<div class='compras'><a href='/web/z-privada_usuario_5.php'>" + "Mis compras" + "</a></div>");
			$e.append("<div class='datos'><a href='/web/zona-privada_usuario_3.php'>" + "Mis datos" + "</a></div>");
			$e.append("<div class='alertas'><a href='/web/zona-privada_usuario_alertas.php'>" + "Mis alertas" + "</a></div>");
			
			$e.append("<div class='logout'><a href='/web/index.php?salir=true'>" + "Cerrar sesión" + "</a></div>");
	...
	function field_text(field) {
		var a = {
			...
			cerrarsesion: "{% trans _('cerrar sesión') %}"
		};
		return a[field];
	}
})();
