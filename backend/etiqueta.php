...
if($accion=="borrar"){
	...
	if (($id<>"")){
		$sqlasiog="UPDATE etiqueta SET borrado='1' WHERE $sql id= '$id' ;";
		$linkb=iConectarse(); 
...
<!------------Arriba pantilla1---------->
	...
	<? include("_aya_mensaje.php"); ?>
		<div class="bloque-lateral acciones">		
   	 				<p>
   	 					<a href="etiqueta2.php" class="btn btn-success" type="button">Nuevo <i class="icon-plus"></i></a> |
...
<?php 
   $link=iConectarse(); 
   $result=pg_query($link,"SELECT * FROM etiqueta WHERE borrado=0 ORDER BY tipo,texto;") ;//or die (mysql_error()); 
?>
