...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Está usando una versión de Internet Explorer demasiado antigua. Debe usar un navegador actualizado. Haga clic aquí para actualizar... ')
