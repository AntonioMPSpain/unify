/*
Head.js carga de forma simultánea y paralela todos los archivos javascript de un sitio web.
De esta forma se acelera la carga de la web, ya que se optimiza ésta.
http://headjs.com/
*/
...
(function (a, w) {
	...
	function s() {
		...
		k(c.screens, function (a) {
			b > a ? (c.screensCss.gt && f("gt-" + a), c.screensCss.gte && f("gte-" + a)) : b < a ? (c.screensCss.lt && f("lt-" + a), c.screensCss.lte && f("lte-" + a)) : b === a && (c.screensCss.lte && f("lte-" + a), c.screensCss.eq && f("e-q" + a), c.screensCss.gte && f("gte-" + a))
		});
